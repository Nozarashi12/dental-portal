        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="font-bold text-lg">Yenepoya Dental Medicine</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400 text-sm">+91 824 220 4666</span>
              </div>
              
              <div className="flex items-center">
                <Mail className="w-5 h-5 text-emerald-400 mr-3 flex-shrink-0" />
                <span className="text-gray-400 text-sm">cde@yenepoya.edu.in</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-xs text-gray-500 text-center md:text-right">
              Yenepoya Dental College is recognized by Dental Council of India
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm text-center md:text-left mb-4 md:mb-0">
              © {new Date().getFullYear()} Yenepoya Dental Medicine. 
              All rights reserved.
            </p>
