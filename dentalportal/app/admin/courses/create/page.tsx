// app/admin/courses/create/page.tsx (Client Component)
'use client'
...
import { 
  ...
  AlertCircle, CheckCircle, Briefcase, Plus
} from 'lucide-react'
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setErrors({ submit: data.message || 'Failed to create course' })
      }
    } catch (error) {
              ...
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Enter the core details of your course</p>
                  </div>
                </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">Keep it concise and engaging</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">Be detailed and specific about course content</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500">Optional - helps build credibility</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2">
                ...
                <span className="text-sm text-gray-700">Provide a clear and descriptive title</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <CheckCircle className="w-3 h-3 text-emerald-600" />
                </div>
                <span className="text-sm text-gray-700">Use categories for better organization</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-gray-700">Use high-quality cover images (16:9 ratio recommended)</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-xs text-blue-600 font-bold">2</span>
                </div>
                <span className="text-sm text-gray-700">Be specific with categories for better filtering</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-xs text-blue-600 font-bold">3</span>
                </div>
                <span className="text-sm text-gray-700">Add detailed descriptions to attract learners</span>
              </li>
            </ul>
          </div>
        </div>
